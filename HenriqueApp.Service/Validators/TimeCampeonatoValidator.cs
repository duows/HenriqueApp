...
namespace HenriqueApp.Service.Validators
{
    public class TimeCampeonatoValidator : AbstractValidator<TimeCampeonato>
    {
        public TimeCampeonatoValidator()
        {
            ...
            RuleFor(c => c.Vitoria)
                .NotEmpty().WithMessage("Por favor informe as Vitoria.")
                .NotNull().WithMessage("Por favor informe as Vitoria.");
            RuleFor(c => c.Derrota)
                .NotEmpty().WithMessage("Por favor informe as Derrota.")
                .NotNull().WithMessage("Por favor informe as Derrota.");
            RuleFor(c => c.Posicao)
